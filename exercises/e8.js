 ...
 * Please, make sure to read the "08-Promise-shortcuts.md" 
 * *file in exercise-info folder before you start!
 * In this task you need to refactor the resolved promise 
 * *with a shortcut of Promise.resolve()
